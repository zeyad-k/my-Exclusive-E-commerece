...
const ProfitIconComponent = (props) => {
  ...
  return (
    <div
      className="about-metric-overview-component flex h-64 w-64 flex-col items-center justify-center gap-2 rounded-md border border-black  border-opacity-30 px-12 py-8 hover:border-none hover:bg-main-active-color hover:text-white hover:shadow-lg"
