const CustomerService = () => {
  return (
    <section className=" Story__Customer__Service flex    flex-wrap items-center justify-center gap-6 lg:flex-nowrap lg:justify-between">
      <div className="Fast__And__Free__Delivery flex flex-col items-center justify-center gap-2    px-12 py-8     ">
        <span className="mb-6">
          <svg
            width="81"
            height="80"
          ...
          >
            ...
            <g clipPath="url(#clip0_4481_3513)">
              <path
        ...
        <h3 className="font-poppins text-lg font-semibold leading-7">
      ...
      <div className="24/7__Customer__Service flex flex-col items-center justify-center gap-2    px-12 py-8     ">
        <span className="mb-6">
          <svg
            width="80"
            height="80"
          ...
          >
            ...
            <g clipPath="url(#clip0_4481_3530)">
              <path
      ...
      <div className="Money__Back__Guarantee flex flex-col items-center justify-center gap-2    px-12 py-8  ">
        <span className="mb-6">
          <svg
            width="80"
            height="80"
